...
public interface CalendarService {
     ...
     */
    List<CalendarDTO> getEventsByDateRange(LocalDateTime startDate, LocalDateTime endDate);
   ...
   List< CalendarDTO > getEventsByStatus(Status status);
     ...
     *
     * @param calendarDTO The TaskEventDTO object to be added.
     */
    void createEvent(CalendarDTO calendarDTO);
